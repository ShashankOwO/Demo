        ...
        if (isInterview) {
          return (
            <div 
              ...
              className="bg-surface border border-border rounded-xl p-4 flex items-center justify-between cursor-pointer hover:shadow-md transition-all group"
            >
              <div className="flex items-center gap-4">
                ...
                <div>
                  <h4 className="font-syne font-bold text-base text-foreground">Interview</h4>
          ...
          return (
            ...
            >
              <div className="flex items-center gap-4">
                ...
                <div>
                  <h4 className="font-syne font-bold text-base text-foreground">Resume Updated</h4>
