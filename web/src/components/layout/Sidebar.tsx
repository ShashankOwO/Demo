...
export const Sidebar: React.FC = () => {
  ...
  return (
    ...
    >
      ...
      <div className="flex items-center gap-[10px] px-[12px] py-[16px] border-b border-white/[0.06]">
        <div className="w-[32px] h-[32px] rounded-[8px] bg-gradient-to-br from-[#6c63ff] to-[#4f46e5] flex items-center justify-center text-white font-syne font-bold text-[16px] flex-shrink-0 shadow-[0_2px_10px_rgba(108,99,255,0.4)]">
          R
        </div>
        <span className="sidebar-app-name font-syne font-semibold text-[14px] text-white whitespace-nowrap overflow-hidden opacity-100 transition-opacity duration-[180ms] ease-out">
          Resume2Interview
        </span>
      </div>
      ...
      <div className="mb-[16px]">
        ...
        >
          ...
          <span className="nav-label text-[13px] font-medium">Logout</span>
        </button>
      </div>
    </aside>
  );
