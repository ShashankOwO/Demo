...
const Profile: React.FC = () => {
  ...
  return (
    <div className="max-w-4xl mx-auto py-8 space-y-8">
      ...
      {/* Hero Card */}
      <Card className="bg-surface border-border overflow-hidden rounded-[24px]">
        {/* Top colorbar */}
        ...
        <CardContent className="relative px-6 pb-8">
          <div className="flex flex-col sm:flex-row sm:items-end gap-4 -mt-14">
            <Avatar className="h-24 w-24 ring-4 ring-card shadow-xl shrink-0">
              <AvatarImage src={getImageUrl(displayProfile?.profile_photo_url)} alt={displayProfile?.name || 'User'} />
