...
.method public final invokeSuspend(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    .line 74
    .local v3, "topNode":Lkotlin/io/path/PathNode;
    invoke-virtual {v3}, Lkotlin/io/path/PathNode;->getContentIterator()Ljava/util/Iterator;
    ...
    .line 76
    .end local v3    # "topNode":Lkotlin/io/path/PathNode;
    .local v7, "topIterator":Ljava/util/Iterator;
    ...
    .line 78
    .end local v7    # "topIterator":Ljava/util/Iterator;
    ...
    iput-object v3, v2, Lkotlin/io/path/PathTreeWalk$dfsIterator$1;->L$3:Ljava/lang/Object;
    ...
    .end local v11    # "entriesReader":Lkotlin/io/path/DirectoryEntriesReader;
    .restart local v3    # "pathNode":Lkotlin/io/path/PathNode;
    .local v7, "this_$iv":Lkotlin/io/path/PathTreeWalk;
    .local v8, "entriesReader":Lkotlin/io/path/DirectoryEntriesReader;
    .local v9, "stack":Lkotlin/collections/ArrayDeque;
    .local v10, "$this$iterator":Lkotlin/sequences/SequenceScope;
    ...
    .line 202
    invoke-virtual {v8, v3}, Lkotlin/io/path/DirectoryEntriesReader;->readEntries(Lkotlin/io/path/PathNode;)Ljava/util/List;
    ...
    invoke-virtual {v3, v13}, Lkotlin/io/path/PathNode;->setContentIterator(Ljava/util/Iterator;)V
    ...
    invoke-direct {v0, v4}, Ljava/nio/file/FileSystemLoopException;-><init>(Ljava/lang/String;)V
    ...
    invoke-static {v13, v3}, Ljava/nio/file/Files;->exists(Ljava/nio/file/Path;[Ljava/nio/file/LinkOption;)Z
    ...
    iput-object v5, v2, Lkotlin/io/path/PathTreeWalk$dfsIterator$1;->L$4:Ljava/lang/Object;

    iput-object v5, v2, Lkotlin/io/path/PathTreeWalk$dfsIterator$1;->L$5:Ljava/lang/Object;

    const/4 v7, 0x4

    iput v7, v2, Lkotlin/io/path/PathTreeWalk$dfsIterator$1;->label:I

    invoke-virtual {v11, v13, v3}, Lkotlin/sequences/SequenceScope;->yield(Ljava/lang/Object;Lkotlin/coroutines/Continuation;)Ljava/lang/Object;
