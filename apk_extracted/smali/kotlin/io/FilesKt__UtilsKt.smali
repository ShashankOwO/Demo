...
.method public static final copyRecursively(Ljava/io/File;Ljava/io/File;ZLkotlin/jvm/functions/Function2;)Z
    ...
    .end local p0    # "$this$copyRecursively":Ljava/io/File;
    .local v4, "$this$copyRecursively":Ljava/io/File;
    ...
    .line 297
    .end local v4    # "$this$copyRecursively":Ljava/io/File;
    .restart local p0    # "$this$copyRecursively":Ljava/io/File;
    :cond_1
    move-object v4, p0

    .line 299
    .end local p0    # "$this$copyRecursively":Ljava/io/File;
    .restart local v4    # "$this$copyRecursively":Ljava/io/File;
    :try_start_0
    ...
    .line 337
    .end local p2    # "overwrite":Z
    .restart local v7    # "overwrite":Z
    .local p0, "e":Lkotlin/io/TerminateException;
    :goto_3
    return v2
.end method
...
.method public static final copyTo(Ljava/io/File;Ljava/io/File;ZI)Ljava/io/File;
    ...
    .local v3, "$i$a$-use-FilesKt__UtilsKt$copyTo$1":I
    ...
    .end local v3    # "$i$a$-use-FilesKt__UtilsKt$copyTo$1":I
    ...
    .restart local v3    # "$i$a$-use-FilesKt__UtilsKt$copyTo$1":I
    :catchall_0
    move-exception v0
    ...
    .end local p0    # "$this$copyTo":Ljava/io/File;
    .local v4, "$this$copyTo":Ljava/io/File;
    invoke-direct/range {v3 .. v8}, Lkotlin/io/NoSuchFileException;-><init>(Ljava/io/File;Ljava/io/File;Ljava/lang/String;ILkotlin/jvm/internal/DefaultConstructorMarker;)V
