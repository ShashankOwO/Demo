...
.method private static final checkContainsAt(Ljava/lang/String;Ljava/lang/String;IILjava/lang/String;)I
    ...
    .end local p0    # "$this$checkContainsAt":Ljava/lang/String;
    .end local p1    # "part":Ljava/lang/String;
    .end local p2    # "index":I
    .local v1, "$this$checkContainsAt":Ljava/lang/String;
    .local v2, "index":I
    ...
    .line 564
    .end local v1    # "$this$checkContainsAt":Ljava/lang/String;
    .end local v2    # "index":I
    .end local v3    # "part":Ljava/lang/String;
    .restart local p0    # "$this$checkContainsAt":Ljava/lang/String;
    .restart local p1    # "part":Ljava/lang/String;
    ...
    .end local p1    # "part":Ljava/lang/String;
    .end local p2    # "index":I
    .restart local v1    # "$this$checkContainsAt":Ljava/lang/String;
...
.method public static final formattedStringLength(IIIIIII)I
    ...
    invoke-direct {v1, v15, v2}, Lkotlin/ranges/IntRange;-><init>(II)V

    check-cast v1, Lkotlin/ranges/ClosedRange;

    invoke-static {v1, v4, v5}, Lkotlin/ranges/RangesKt;->intRangeContains(Lkotlin/ranges/ClosedRange;J)Z
    ...
    const-string v8, "The resulting string length is too big: "
    ...
    invoke-static {v8, v9}, Lkotlin/ULong;->toString-impl(J)Ljava/lang/String;
    ...
    .end local v7    # "groupSeparators":I
...
.method private static final hexToByteArray(Ljava/lang/String;IILkotlin/text/HexFormat;)[B
    ...
    .line 215
    .local v10, "indexInLine":I
    const/4 v15, 0x0

    .line 217
    .local v15, "indexInGroup":I
    :goto_0
    if-ge v8, v2, :cond_4
    ...
    .line 219
    invoke-static {v0, v8, v2}, Lkotlin/text/HexExtensionsKt;->checkNewLineAt(Ljava/lang/String;II)I
    ...
    invoke-static {v0, v14, v8, v2, v1}, Lkotlin/text/HexExtensionsKt;->checkContainsAt(Ljava/lang/String;Ljava/lang/String;IILjava/lang/String;)I
    ...
    invoke-static {v0, v13, v8, v2, v1}, Lkotlin/text/HexExtensionsKt;->checkContainsAt(Ljava/lang/String;Ljava/lang/String;IILjava/lang/String;)I
    ...
    invoke-static {v0, v11, v8, v2, v1}, Lkotlin/text/HexExtensionsKt;->checkContainsAt(Ljava/lang/String;Ljava/lang/String;IILjava/lang/String;)I
    ...
    .end local v4    # "resultCapacity":I
    .local v17, "resultCapacity":I
    invoke-static {v0, v1, v8, v3, v4}, Lkotlin/text/HexExtensionsKt;->checkHexLength(Ljava/lang/String;IIIZ)V
    ...
    invoke-static {v0, v4}, Lkotlin/text/HexExtensionsKt;->decimalFromHexDigitAt(Ljava/lang/String;I)I
    ...
    invoke-static {v0, v12, v8, v2, v1}, Lkotlin/text/HexExtensionsKt;->checkContainsAt(Ljava/lang/String;Ljava/lang/String;IILjava/lang/String;)I
    ...
    .line 240
    .end local v16    # "bytesFormat":Lkotlin/text/HexFormat$BytesHexFormat;
    .end local v17    # "resultCapacity":I
    .local v3, "bytesFormat":Lkotlin/text/HexFormat$BytesHexFormat;
    .local v4, "resultCapacity":I
    .restart local v9    # "byteIndex":I
    :cond_4
    move-object/from16 v16, v3
    ...
    .end local v3    # "bytesFormat":Lkotlin/text/HexFormat$BytesHexFormat;
    .end local v4    # "resultCapacity":I
    .restart local v16    # "bytesFormat":Lkotlin/text/HexFormat$BytesHexFormat;
    .restart local v17    # "resultCapacity":I
    array-length v1, v7
...
.method public static final parsedByteArrayMaxSize(IIIIIII)I
    ...
    .line 278
    .local v13, "charsPerLine":J
    int-to-long v5, v0

    .line 281
    .local v5, "numberOfChars":J
    const/4 v7, 0x1
    ...
    .line 253
    .end local v5    # "numberOfChars":J
    .end local v7    # "charsPerByte":J
    .end local v11    # "charsPerGroup":J
    .end local v13    # "charsPerLine":J
    .end local v15    # "spare":I
...
.method public static final toHexString([BIILkotlin/text/HexFormat;)Ljava/lang/String;
    ...
    .line 69
    .local v6, "groupSeparator":Ljava/lang/String;
    move-object v9, v6

    .end local v6    # "groupSeparator":Ljava/lang/String;
    .local v9, "groupSeparator":Ljava/lang/String;
    sub-int v6, v2, v1
    ...
    .end local v9    # "groupSeparator":Ljava/lang/String;
    ...
    .local v11, "groupSeparator":Ljava/lang/String;
    ...
    .end local v11    # "groupSeparator":Ljava/lang/String;
    .local v12, "groupSeparator":Ljava/lang/String;
    invoke-virtual {v13}, Ljava/lang/String;->length()I
    ...
    .end local v12    # "groupSeparator":Ljava/lang/String;
    .local v16, "groupSeparator":Ljava/lang/String;
    invoke-virtual {v14}, Ljava/lang/String;->length()I
    ...
    .end local v16    # "groupSeparator":Ljava/lang/String;
    ...
    .line 79
    .local v9, "indexInLine":I
    const/4 v10, 0x0

    .line 81
    .local v10, "indexInGroup":I
    ...
    .local v12, "$this$toHexString_u24lambda_u243":Ljava/lang/StringBuilder;
    const/16 v16, 0x0

    .line 82
    .local v16, "$i$a$-buildString-HexExtensionsKt$toHexString$1":I
    move/from16 v17, p1
    ...
    .line 89
    .end local v19    # "byte":I
    .restart local v1    # "byte":I
    :cond_2
    move/from16 v19, v1

    .end local v1    # "byte":I
    .restart local v19    # "byte":I
    if-ne v10, v8, :cond_3
    ...
    .line 81
    .end local v12    # "$this$toHexString_u24lambda_u243":Ljava/lang/StringBuilder;
    .end local v16    # "$i$a$-buildString-HexExtensionsKt$toHexString$1":I
    ...
    .line 106
    .restart local v12    # "$this$toHexString_u24lambda_u243":Ljava/lang/StringBuilder;
    .restart local v16    # "$i$a$-buildString-HexExtensionsKt$toHexString$1":I
    :cond_7
