...
.method static constructor <clinit>()V
    ...
    const-string/jumbo v0, "sendersAndCloseStatus"
...
.method private final findSegmentBufferEnd(JLkotlinx/coroutines/channels/ChannelSegment;J)Lkotlinx/coroutines/channels/ChannelSegment;
    ...
    .line 4093
    .local v3, "$i$f$findSegmentAndMoveForward$atomicfu":I
    :cond_0
    nop
    ...
    .line 4095
    .local v4, "s$iv":Ljava/lang/Object;
    ...
    .local v5, "to$iv$iv":Lkotlinx/coroutines/internal/Segment;
    const/4 v10, 0x0
    ...
    .line 4095
    .end local v5    # "to$iv$iv":Lkotlinx/coroutines/internal/Segment;
    ...
    .line 4102
    .restart local v5    # "to$iv$iv":Lkotlinx/coroutines/internal/Segment;
    .restart local v10    # "$i$f$moveForward$atomicfu":I
    ...
    .end local v3    # "$i$f$findSegmentAndMoveForward$atomicfu":I
    .end local v4    # "s$iv":Ljava/lang/Object;
    .end local v5    # "to$iv$iv":Lkotlinx/coroutines/internal/Segment;
    .end local v10    # "$i$f$moveForward$atomicfu":I
    .end local v11    # "$i$f$loop$atomicfu":I
    :cond_6
    ...
    .line 2466
    .local v9, "$i$a$-let-BufferedChannel$findSegmentBufferEnd$1":I
    ...
    .end local v9    # "$i$a$-let-BufferedChannel$findSegmentBufferEnd$1":I
    nop
...
.method private final findSegmentReceive(JLkotlinx/coroutines/channels/ChannelSegment;)Lkotlinx/coroutines/channels/ChannelSegment;
    ...
    .local v3, "atomicfu$handler$iv":Ljava/util/concurrent/atomic/AtomicReferenceFieldUpdater;
    .local v4, "createNewSegment$iv":Lkotlin/jvm/functions/Function2;
    const/4 v5, 0x0

    .line 4074
    .local v5, "$i$f$findSegmentAndMoveForward$atomicfu":I
    :goto_0
    nop
    ...
    .line 2416
    .end local v3    # "atomicfu$handler$iv":Ljava/util/concurrent/atomic/AtomicReferenceFieldUpdater;
    .end local v4    # "createNewSegment$iv":Lkotlin/jvm/functions/Function2;
    .end local v5    # "$i$f$findSegmentAndMoveForward$atomicfu":I
    ...
    .line 2417
    .local v0, "$i$a$-let-BufferedChannel$findSegmentReceive$1":I
    invoke-static {v6}, Lkotlinx/coroutines/internal/SegmentOrClosed;->isClosed-impl(Ljava/lang/Object;)Z
    ...
    .local v5, "$i$f$moveForward$atomicfu":I
    const/4 v7, 0x0

    .local v7, "$i$f$loop$atomicfu":I
    :goto_4
    ...
    .local v8, "cur$iv":Lkotlinx/coroutines/internal/Segment;
    const/4 v9, 0x0

    .line 4085
    .local v9, "$i$a$-loop$atomicfu-ConcurrentLinkedListKt$moveForward$atomicfu$1$iv":I
    ...
    .end local v8    # "cur$iv":Lkotlinx/coroutines/internal/Segment;
    .end local v9    # "$i$a$-loop$atomicfu-ConcurrentLinkedListKt$moveForward$atomicfu$1$iv":I
    goto :goto_4

    .line 2439
    .end local v4    # "atomicfu$handler$iv":Ljava/util/concurrent/atomic/AtomicReferenceFieldUpdater;
    .end local v5    # "$i$f$moveForward$atomicfu":I
    .end local v7    # "$i$f$loop$atomicfu":I
    :cond_c
    :goto_5
    ...
    .line 2416
    .end local v0    # "$i$a$-let-BufferedChannel$findSegmentReceive$1":I
...
.method private final updateReceiversCounterIfLower(J)V
    ...
    .line 2554
    .local v9, "$i$a$-loop$atomicfu-BufferedChannel$updateReceiversCounterIfLower$1":I
    cmp-long v3, v5, p1
    ...
    .end local v5    # "cur":J
    .end local v9    # "$i$a$-loop$atomicfu-BufferedChannel$updateReceiversCounterIfLower$1":I
    goto :goto_0
.end method
...
.method private final updateSendersCounterIfLower(J)V
    ...
    .line 2539
    .local v9, "$i$a$-loop$atomicfu-BufferedChannel$updateSendersCounterIfLower$1":I
    move-wide v3, v5
    ...
    .end local v9    # "$i$a$-loop$atomicfu-BufferedChannel$updateSendersCounterIfLower$1":I
...
.method public toString()Ljava/lang/String;
    ...
    const-string/jumbo v15, "receive"
    ...
    const-string/jumbo v15, "receiveCatching"
...
.method public final waitExpandBufferCompletion$kotlinx_coroutines_core(J)V
    ...
    .local v10, "$i$f$update$atomicfu":I
    :goto_2
    ...
    .line 1416
    .local v11, "$i$a$-update$atomicfu-BufferedChannel$waitExpandBufferCompletion$2":I
    move-wide v12, v4
    ...
    .line 3893
    .local v14, "$i$f$getEbCompletedCounter":I
    and-long/2addr v12, v7

    .line 1416
    .end local v12    # "$this$ebCompletedCounter$iv":J
    .end local v14    # "$i$f$getEbCompletedCounter":I
    const/4 v14, 0x1
    ...
    .end local v4    # "it":J
    .end local v11    # "$i$a$-update$atomicfu-BufferedChannel$waitExpandBufferCompletion$2":I
    invoke-virtual/range {v0 .. v5}, Ljava/util/concurrent/atomic/AtomicLongFieldUpdater;->compareAndSet(Ljava/lang/Object;JJ)Z
    ...
    .end local v10    # "$i$f$update$atomicfu":I
    :goto_3
    nop
    ...
    .local v15, "this_$iv":Lkotlinx/coroutines/channels/BufferedChannel;
    const/16 v16, 0x0

    .local v16, "$i$f$update$atomicfu":I
    :goto_5
    move-wide v4, v2

    .end local v2    # "ebCompleted":J
    ...
    .line 1433
    .local v14, "$i$a$-update$atomicfu-BufferedChannel$waitExpandBufferCompletion$3":I
    ...
    .end local v14    # "$i$a$-update$atomicfu-BufferedChannel$waitExpandBufferCompletion$3":I
    .end local v17    # "it":J
    ...
    .line 1435
    .end local v0    # "atomicfu$handler$iv":Ljava/util/concurrent/atomic/AtomicLongFieldUpdater;
    .end local v15    # "this_$iv":Lkotlinx/coroutines/channels/BufferedChannel;
    .end local v16    # "$i$f$update$atomicfu":I
    return-void

    .line 1433
    .restart local v0    # "atomicfu$handler$iv":Ljava/util/concurrent/atomic/AtomicLongFieldUpdater;
    .restart local v15    # "this_$iv":Lkotlinx/coroutines/channels/BufferedChannel;
    .restart local v16    # "$i$f$update$atomicfu":I
    :cond_4
    move-object/from16 v1, p0
    ...
    .end local v15    # "this_$iv":Lkotlinx/coroutines/channels/BufferedChannel;
    .end local v16    # "$i$f$update$atomicfu":I
    .restart local v2    # "ebCompleted":J
    :cond_5
    move-wide/from16 v22, v7
    ...
    .restart local v0    # "atomicfu$handler$iv":Ljava/util/concurrent/atomic/AtomicLongFieldUpdater;
    .local v9, "this_$iv":Lkotlinx/coroutines/channels/BufferedChannel;
    .restart local v10    # "$i$f$update$atomicfu":I
    :cond_7
    move-wide/from16 v22, v7
