...
.method public varargs constructor <init>(Landroidx/room/RoomDatabase;Ljava/util/Map;Ljava/util/Map;[Ljava/lang/String;)V
    ...
    const-string/jumbo v5, "shadowTablesMap"

    invoke-static {v2, v5}, Lkotlin/jvm/internal/Intrinsics;->checkNotNullParameter(Ljava/lang/Object;Ljava/lang/String;)V

    const-string/jumbo v5, "viewTables"

    invoke-static {v3, v5}, Lkotlin/jvm/internal/Intrinsics;->checkNotNullParameter(Ljava/lang/Object;Ljava/lang/String;)V

    const-string/jumbo v5, "tableNames"
    ...
    .line 97
    .local v9, "shadowTableName":Ljava/lang/String;
    :goto_1
    if-nez v9, :cond_1
    ...
    .end local v9    # "shadowTableName":Ljava/lang/String;
...
.method private final startTrackingTable(Landroidx/sqlite/db/SupportSQLiteDatabase;I)V
    ...
    const-string/jumbo v10, "table_id"
...
.method public addObserver(Landroidx/room/InvalidationTracker$Observer;)V
    ...
    invoke-virtual {v3, v4}, Landroidx/room/InvalidationTracker$ObservedTableTracker;->onAdded([I)Z
...
.method public removeObserver(Landroidx/room/InvalidationTracker$Observer;)V
    ...
    invoke-virtual {v2}, Landroidx/room/InvalidationTracker$ObserverWrapper;->getTableIds$room_runtime_release()[I
    ...
    invoke-virtual {v0, v1}, Landroidx/room/InvalidationTracker$ObservedTableTracker;->onRemoved([I)Z
    ...
    .line 321
    .end local v2    # "wrapper":Landroidx/room/InvalidationTracker$ObserverWrapper;
    :catchall_0
    move-exception v1
