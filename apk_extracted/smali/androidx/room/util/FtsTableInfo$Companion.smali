...
.method private final readOptions(Landroidx/sqlite/db/SupportSQLiteDatabase;Ljava/lang/String;)Ljava/util/Set;
    ...
    invoke-virtual {p0, v5}, Landroidx/room/util/FtsTableInfo$Companion;->parseOptions(Ljava/lang/String;)Ljava/util/Set;
...
.method public final parseOptions(Ljava/lang/String;)Ljava/util/Set;
    ...
    .restart local v20    # "endIndex$iv$iv":I
    ...
    .line 174
    .local v12, "$i$a$-filter-FtsTableInfo$Companion$parseOptions$options$1":I
    invoke-static {}, Landroidx/room/util/FtsTableInfo;->access$getFTS_OPTIONS$cp()[Ljava/lang/String;

    move-result-object v13

    .local v13, "$this$any$iv":[Ljava/lang/Object;
    const/4 v14, 0x0
    ...
    .local v20, "validOption":Ljava/lang/String;
    const/16 v21, 0x0

    .line 175
    .local v21, "$i$a$-any-FtsTableInfo$Companion$parseOptions$options$1$1":I
    move/from16 v22, v0
    ...
    .local v23, "argsString":Ljava/lang/String;
    const/4 v1, 0x0
    ...
    .end local v20    # "validOption":Ljava/lang/String;
    .local v2, "validOption":Ljava/lang/String;
    .local v17, "$this$filterTo$iv$iv":Ljava/lang/Iterable;
    .local v24, "$i$f$filter":I
    invoke-static {v11, v2, v4, v0, v1}, Lkotlin/text/StringsKt;->startsWith$default(Ljava/lang/String;Ljava/lang/String;ZILjava/lang/Object;)Z

    move-result v0

    .line 225
    .end local v2    # "validOption":Ljava/lang/String;
    .end local v21    # "$i$a$-any-FtsTableInfo$Companion$parseOptions$options$1$1":I
    if-eqz v0, :cond_17
    ...
    .end local v23    # "argsString":Ljava/lang/String;
    ...
    .end local v4    # "$this$filterTo$iv$iv":Ljava/lang/Iterable;
    .restart local v17    # "$this$filterTo$iv$iv":Ljava/lang/Iterable;
    .restart local v23    # "argsString":Ljava/lang/String;
    .restart local v24    # "$i$f$filter":I
    move v0, v4

    .line 174
    .end local v13    # "$this$any$iv":[Ljava/lang/Object;
    ...
    .end local v12    # "$i$a$-filter-FtsTableInfo$Companion$parseOptions$options$1":I
    if-eqz v0, :cond_19
