...
.method private static final readColumns(Landroidx/sqlite/db/SupportSQLiteDatabase;Ljava/lang/String;)Ljava/util/Map;
    ...
    .local v1, "$this$readColumns_u24lambda_u246_u24lambda_u245":Ljava/util/Map;
    ...
    .line 572
    .end local v1    # "$this$readColumns_u24lambda_u246_u24lambda_u245":Ljava/util/Map;
    .end local v10    # "name":Ljava/lang/String;
    .end local v21    # "type":Ljava/lang/String;
...
.method private static final readForeignKeys(Landroidx/sqlite/db/SupportSQLiteDatabase;Ljava/lang/String;)Ljava/util/Set;
    ...
    .line 495
    .local v23, "myColumns":Ljava/util/List;
    new-instance v17, Ljava/util/ArrayList;
    ...
    .line 497
    .local v17, "refColumns":Ljava/util/List;
    ...
    .local v21, "$this$filterTo$iv$iv":Ljava/lang/Iterable;
    const/16 v24, 0x0

    .line 650
    .local v24, "$i$f$filterTo":I
    ...
    check-cast v26, Landroidx/room/util/TableInfo$ForeignKeyWithSequence;

    .local v26, "it":Landroidx/room/util/TableInfo$ForeignKeyWithSequence;
    const/16 v28, 0x0

    .line 498
    .local v28, "$i$a$-filter-TableInfoKt$readForeignKeys$1$1$1":I
    invoke-virtual/range {v26 .. v26}, Landroidx/room/util/TableInfo$ForeignKeyWithSequence;->getId()I
    ...
    .line 650
    .end local v26    # "it":Landroidx/room/util/TableInfo$ForeignKeyWithSequence;
    .end local v28    # "$i$a$-filter-TableInfoKt$readForeignKeys$1$1$1":I
    :goto_2
    if-eqz v1, :cond_2
    ...
    .end local v18    # "id":I
    .local v2, "id":I
    .restart local v22    # "destination$iv$iv":Ljava/util/Collection;
    ...
    .end local v21    # "$this$filterTo$iv$iv":Ljava/lang/Iterable;
    .end local v22    # "destination$iv$iv":Ljava/util/Collection;
    .end local v24    # "$i$f$filterTo":I
    ...
    check-cast v21, Landroidx/room/util/TableInfo$ForeignKeyWithSequence;

    .local v21, "key":Landroidx/room/util/TableInfo$ForeignKeyWithSequence;
    const/16 v22, 0x0

    .line 500
    .local v22, "$i$a$-forEach-TableInfoKt$readForeignKeys$1$1$2":I
    move-object/from16 v24, v1

    .end local v1    # "$this$forEach$iv":Ljava/lang/Iterable;
    .local v24, "$this$forEach$iv":Ljava/lang/Iterable;
    invoke-virtual/range {v21 .. v21}, Landroidx/room/util/TableInfo$ForeignKeyWithSequence;->getFrom()Ljava/lang/String;
    ...
    .end local v23    # "myColumns":Ljava/util/List;
    .local v2, "myColumns":Ljava/util/List;
    .local v25, "$i$f$forEach":I
    invoke-interface {v2, v1}, Ljava/util/List;->add(Ljava/lang/Object;)Z

    .line 501
    invoke-virtual/range {v21 .. v21}, Landroidx/room/util/TableInfo$ForeignKeyWithSequence;->getTo()Ljava/lang/String;
    ...
    .end local v17    # "refColumns":Ljava/util/List;
    .local v2, "refColumns":Ljava/util/List;
    .restart local v23    # "myColumns":Ljava/util/List;
    invoke-interface {v2, v1}, Ljava/util/List;->add(Ljava/lang/Object;)Z
    ...
    .line 652
    .end local v21    # "key":Landroidx/room/util/TableInfo$ForeignKeyWithSequence;
    .end local v22    # "$i$a$-forEach-TableInfoKt$readForeignKeys$1$1$2":I
    ...
    .local v2, "$i$f$forEach":I
    .restart local v17    # "refColumns":Ljava/util/List;
    :cond_4
    move-object/from16 v24, v1
    ...
    .end local v2    # "refColumns":Ljava/util/List;
    .local v24, "refColumns":Ljava/util/List;
    const-string v2, "cursor.getString(tableColumnIndex)"
    ...
    const-string v1, "cursor.getString(onDeleteColumnIndex)"
    ...
    .end local v18    # "id":I
    .end local v23    # "myColumns":Ljava/util/List;
    .end local v24    # "refColumns":Ljava/util/List;
...
.method private static final readIndices(Landroidx/sqlite/db/SupportSQLiteDatabase;Ljava/lang/String;)Ljava/util/Set;
    ...
    invoke-static {v1, v12, v3}, Landroidx/room/util/TableInfoKt;->readIndex(Landroidx/sqlite/db/SupportSQLiteDatabase;Ljava/lang/String;Z)Landroidx/room/util/TableInfo$Index;
    ...
    .line 599
    .local v2, "index":Landroidx/room/util/TableInfo$Index;
