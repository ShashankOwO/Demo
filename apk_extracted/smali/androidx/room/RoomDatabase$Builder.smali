...
.method public build()Landroidx/room/RoomDatabase;
    ...
    .line 1274
    .local v3, "$i$a$-let-RoomDatabase$Builder$build$factory$1":I
    ...
    .line 1283
    .local v4, "autoCloser":Landroidx/room/AutoCloser;
    ...
    .end local v4    # "autoCloser":Landroidx/room/AutoCloser;
    ...
    .end local v3    # "$i$a$-let-RoomDatabase$Builder$build$factory$1":I
    nop
    ...
    .local v5, "it":Landroidx/sqlite/db/SupportSQLiteOpenHelper$Factory;
    const/4 v1, 0x0

    .line 1288
    .local v1, "$i$a$-let-RoomDatabase$Builder$build$factory$2":I
    nop
    ...
    .line 1298
    .local v3, "copyFromAssetPathConfig":I
    :goto_5
    ...
    .line 1309
    invoke-direct {v4, v6, v10, v11, v5}, Landroidx/room/SQLiteCopyOpenHelperFactory;-><init>(Ljava/lang/String;Ljava/io/File;Ljava/util/concurrent/Callable;Landroidx/sqlite/db/SupportSQLiteOpenHelper$Factory;)V

    .end local v3    # "copyFromAssetPathConfig":I
    ...
    .line 1287
    .end local v1    # "$i$a$-let-RoomDatabase$Builder$build$factory$2":I
    .end local v5    # "it":Landroidx/sqlite/db/SupportSQLiteOpenHelper$Factory;
    goto :goto_9

    .line 1303
    .restart local v1    # "$i$a$-let-RoomDatabase$Builder$build$factory$2":I
    .restart local v3    # "copyFromAssetPathConfig":I
    .restart local v5    # "it":Landroidx/sqlite/db/SupportSQLiteOpenHelper$Factory;
    ...
    .line 1319
    .local v1, "$i$a$-let-RoomDatabase$Builder$build$factory$3":I
    if-eqz v4, :cond_18
    ...
    .line 1321
    invoke-direct {v3, v4, v5, v6}, Landroidx/room/QueryInterceptorOpenHelperFactory;-><init>(Landroidx/sqlite/db/SupportSQLiteOpenHelper$Factory;Ljava/util/concurrent/Executor;Landroidx/room/RoomDatabase$QueryCallback;)V

    check-cast v3, Landroidx/sqlite/db/SupportSQLiteOpenHelper$Factory;
    ...
    .line 1318
    .end local v1    # "$i$a$-let-RoomDatabase$Builder$build$factory$3":I
    ...
    invoke-virtual {v1, v3}, Landroidx/room/RoomDatabase$JournalMode;->resolve$room_runtime_release(Landroid/content/Context;)Landroidx/room/RoomDatabase$JournalMode;
    ...
    .line 1341
    iget-boolean v1, v0, Landroidx/room/RoomDatabase$Builder;->requireMigration:Z
    ...
    .line 1351
    .local v5, "configuration":Landroidx/room/DatabaseConfiguration;
    ...
    .line 1339
    .end local v1    # "db":Landroidx/room/RoomDatabase;
    .end local v5    # "configuration":Landroidx/room/DatabaseConfiguration;
    :cond_16
