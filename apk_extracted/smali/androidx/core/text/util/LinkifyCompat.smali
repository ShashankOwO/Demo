...
.method public static addLinks(Landroid/widget/TextView;Ljava/util/regex/Pattern;Ljava/lang/String;[Ljava/lang/String;Landroid/text/util/Linkify$MatchFilter;Landroid/text/util/Linkify$TransformFilter;)V
    ...
    .line 255
    .end local v2    # "defaultScheme":Ljava/lang/String;
    .end local v3    # "schemes":[Ljava/lang/String;
    .end local v4    # "matchFilter":Landroid/text/util/Linkify$MatchFilter;
    .end local v5    # "transformFilter":Landroid/text/util/Linkify$TransformFilter;
    .local p1, "linksAdded":Z
    .restart local p2    # "defaultScheme":Ljava/lang/String;
    .restart local p3    # "schemes":[Ljava/lang/String;
    .restart local p4    # "matchFilter":Landroid/text/util/Linkify$MatchFilter;
    .restart local p5    # "transformFilter":Landroid/text/util/Linkify$TransformFilter;
    if-eqz p1, :cond_1
...
.method public static addLinks(Landroid/text/Spannable;I)Z
    ...
    .line 111
    .local v4, "links":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Landroidx/core/text/util/LinkifyCompat$LinkSpec;>;"
    ...
    .line 134
    .local v0, "link":Landroidx/core/text/util/LinkifyCompat$LinkSpec;
    ...
    .line 137
    .end local v0    # "link":Landroidx/core/text/util/LinkifyCompat$LinkSpec;
    :cond_8
    goto :goto_2
