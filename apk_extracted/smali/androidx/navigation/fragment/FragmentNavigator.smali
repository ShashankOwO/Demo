...
.method private final navigate(Landroidx/navigation/NavBackStackEntry;Landroidx/navigation/NavOptions;Landroidx/navigation/Navigator$Extras;)V
    ...
    invoke-virtual {v8, v0}, Landroidx/fragment/app/FragmentTransaction;->addToBackStack(Ljava/lang/String;)Landroidx/fragment/app/FragmentTransaction;
    ...
    invoke-virtual {v8, v2, v1}, Landroidx/fragment/app/FragmentTransaction;->addSharedElement(Landroid/view/View;Ljava/lang/String;)Landroidx/fragment/app/FragmentTransaction;
...
.method public popBackStack(Landroidx/navigation/NavBackStackEntry;Z)V
    ...
    .line 295
    invoke-interface {v8, v9, v1}, Ljava/util/List;->subList(II)Ljava/util/List;

    move-result-object v10

    .line 299
    .local v10, "poppedList":Ljava/util/List;
    ...
    .line 300
    .local v11, "initialEntry":Landroidx/navigation/NavBackStackEntry;
    if-eqz v7, :cond_2
    ...
    .line 310
    :cond_1
    iget-object v4, v0, Landroidx/navigation/fragment/FragmentNavigator;->fragmentManager:Landroidx/fragment/app/FragmentManager;
    ...
    .line 311
    iget-object v4, v0, Landroidx/navigation/fragment/FragmentNavigator;->savedIds:Ljava/util/Set;
    ...
    const-string v3, "Calling popWithTransition via popBackStack() on entry "
    ...
    .line 323
    const-string v3, " with savedState "
    ...
    .line 329
    .local v12, "incomingEntry":Landroidx/navigation/NavBackStackEntry;
    if-eqz v12, :cond_5
    ...
    .line 333
    .local v15, "$i$a$-filter-FragmentNavigator$popBackStack$1":I
    ...
    .end local v15    # "$i$a$-filter-FragmentNavigator$popBackStack$1":I
    if-nez v0, :cond_6
    ...
    .restart local v17    # "$i$f$filter":I
    move-object v0, v2
    ...
    .line 334
    .local v18, "$i$a$-forEach-FragmentNavigator$popBackStack$2":I
    ...
    .end local v18    # "$i$a$-forEach-FragmentNavigator$popBackStack$2":I
    nop
    ...
    invoke-virtual {v0, v6, v7}, Landroidx/navigation/NavigatorState;->popWithTransition(Landroidx/navigation/NavBackStackEntry;Z)V
