...
.method private final addEntryToBackStack(Landroidx/navigation/NavDestination;Landroid/os/Bundle;Landroidx/navigation/NavBackStackEntry;Ljava/util/List;)V
    ...
    .line 2113
    .local v12, "overlappingDestination":Landroidx/navigation/NavDestination;
    :goto_b
    iget-object v1, v0, Landroidx/navigation/NavController;->backQueue:Lkotlin/collections/ArrayDeque;
    ...
    .line 2114
    invoke-virtual {v1, v2, v11}, Landroidx/navigation/NavGraph;->findNode(IZ)Landroidx/navigation/NavDestination;
    ...
    .local v11, "restoredEntry":Landroidx/navigation/NavBackStackEntry;
    const/4 v13, 0x0
    ...
    .line 2704
    .end local v11    # "restoredEntry":Landroidx/navigation/NavBackStackEntry;
    ...
    invoke-virtual {v15, v11}, Landroidx/navigation/NavController$NavControllerNavigatorState;->addInternal(Landroidx/navigation/NavBackStackEntry;)V
    ...
    .line 2138
    .restart local v5    # "element$iv":Ljava/lang/Object;
    .restart local v11    # "entry":Landroidx/navigation/NavBackStackEntry;
    ...
    .line 2151
    .local v11, "$i$a$-forEach-NavController$addEntryToBackStack$2":I
    ...
    .end local v11    # "$i$a$-forEach-NavController$addEntryToBackStack$2":I
...
.method private final executePopOperations(Ljava/util/List;Landroidx/navigation/NavDestination;ZZ)Z
    ...
    .line 661
    new-instance v6, Landroidx/navigation/NavController$executePopOperations$3;

    invoke-direct {v6, v3}, Landroidx/navigation/NavController$executePopOperations$3;-><init>(Landroidx/navigation/NavController;)V

    check-cast v6, Lkotlin/jvm/functions/Function1;

    invoke-static {v0, v6}, Lkotlin/sequences/SequencesKt;->takeWhile(Lkotlin/sequences/Sequence;Lkotlin/jvm/functions/Function1;)Lkotlin/sequences/Sequence;
    ...
    iget-object v11, v3, Landroidx/navigation/NavController;->backStackMap:Ljava/util/Map;
    ...
    invoke-virtual {v3, v6}, Landroidx/navigation/NavController;->findDestination(I)Landroidx/navigation/NavDestination;

    move-result-object v6

    .line 674
    .local v6, "firstStateDestination":Landroidx/navigation/NavDestination;
    ...
    .end local v6    # "firstStateDestination":Landroidx/navigation/NavDestination;
    :cond_6
    move-object/from16 v1, p2
...
.method private final instantiateBackStack(Lkotlin/collections/ArrayDeque;)Ljava/util/List;
    ...
    invoke-direct {p0, v2, v8}, Landroidx/navigation/NavController;->findDestination(Landroidx/navigation/NavDestination;I)Landroidx/navigation/NavDestination;
...
.method public handleDeepLink(Landroid/content/Intent;)Z
    ...
    invoke-static {v6, v9, v12, v9}, Landroidx/navigation/NavDestination;->buildDeepLinkIds$default(Landroidx/navigation/NavDestination;Landroidx/navigation/NavDestination;ILjava/lang/Object;)[I
    ...
    invoke-virtual {v6, v13}, Landroidx/navigation/NavDestination;->addInDefaultArgs(Landroid/os/Bundle;)Landroid/os/Bundle;

    move-result-object v13

    .line 1342
    .local v13, "destinationArgs":Landroid/os/Bundle;
    if-eqz v13, :cond_7
    ...
    .end local v13    # "destinationArgs":Landroid/os/Bundle;
    :cond_7
    move-object v13, v4
...
.method public setGraph(Landroidx/navigation/NavGraph;Landroid/os/Bundle;)V
    ...
    .line 1187
    .local v8, "$i$a$-let-NavController$setGraph$1":I
    new-instance v1, Ljava/util/ArrayList;
    ...
    .line 1189
    .local v10, "$i$a$-forEach-NavController$setGraph$1$1":I
    const-string v11, "id"
    ...
    .end local v10    # "$i$a$-forEach-NavController$setGraph$1$1":I
    nop
    ...
    .end local v8    # "$i$a$-let-NavController$setGraph$1":I
