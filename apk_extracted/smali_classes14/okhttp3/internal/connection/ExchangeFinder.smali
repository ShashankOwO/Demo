...
.method private final findConnection(IIIIZ)Lokhttp3/internal/connection/RealConnection;
    ...
    .local v6, "toClose":Ljava/lang/Object;
    move-object v4, v6

    .line 160
    .end local v6    # "toClose":Ljava/lang/Object;
    ...
    invoke-virtual {v5, v8}, Lokhttp3/internal/connection/RealCall;->setConnectionToCancel(Lokhttp3/internal/connection/RealConnection;)V
    ...
    invoke-virtual {v5, v7}, Lokhttp3/internal/connection/RealCall;->setConnectionToCancel(Lokhttp3/internal/connection/RealConnection;)V
    ...
    invoke-virtual {v5, v6}, Lokhttp3/internal/connection/RouteDatabase;->connected(Lokhttp3/Route;)V
    ...
    invoke-virtual {v5, v6, v7, v3, v0}, Lokhttp3/internal/connection/RealConnectionPool;->callAcquirePooledConnection(Lokhttp3/Address;Lokhttp3/internal/connection/RealCall;Ljava/util/List;Z)Z
    ...
    invoke-virtual {v5, v6, v7}, Lokhttp3/EventListener;->connectionAcquired(Lokhttp3/Call;Lokhttp3/Connection;)V
    ...
    invoke-virtual {v5, v8}, Lokhttp3/internal/connection/RealConnectionPool;->put(Lokhttp3/internal/connection/RealConnection;)V

    .line 252
    iget-object v5, v1, Lokhttp3/internal/connection/ExchangeFinder;->call:Lokhttp3/internal/connection/RealCall;

    invoke-virtual {v5, v8}, Lokhttp3/internal/connection/RealCall;->acquireConnectionNoEvents(Lokhttp3/internal/connection/RealConnection;)V
    ...
    invoke-virtual {v0, v5, v6}, Lokhttp3/EventListener;->connectionAcquired(Lokhttp3/Call;Lokhttp3/Connection;)V
...
.method private final findHealthyConnection(IIIIZZ)Lokhttp3/internal/connection/RealConnection;
    ...
    .local v1, "connectionRetryEnabled":Z
    .local p2, "connectTimeout":I
    .local p3, "readTimeout":I
    .local p4, "writeTimeout":I
    .local p5, "pingIntervalMillis":I
    ...
    .line 130
    .local v3, "routesSelectionLeft":Z
    :cond_2
    if-eqz v3, :cond_3
    ...
    .line 127
    .end local v3    # "routesSelectionLeft":Z
    :cond_4
    move p1, p2
