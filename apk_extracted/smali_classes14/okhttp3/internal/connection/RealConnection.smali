...
.method private final connectTls(Lokhttp3/internal/connection/ConnectionSpecSelector;)V
    ...
    .line 420
    .local v11, "maybeProtocol":Ljava/lang/String;
    move-object v10, v5

    check-cast v10, Ljava/net/Socket;

    iput-object v10, v1, Lokhttp3/internal/connection/RealConnection;->socket:Ljava/net/Socket;
    ...
    iput-object v10, v1, Lokhttp3/internal/connection/RealConnection;->source:Lokio/BufferedSource;
    ...
    iput-object v10, v1, Lokhttp3/internal/connection/RealConnection;->sink:Lokio/BufferedSink;

    .line 423
    if-eqz v11, :cond_4

    sget-object v10, Lokhttp3/Protocol;->Companion:Lokhttp3/Protocol$Companion;

    invoke-virtual {v10, v11}, Lokhttp3/Protocol$Companion;->get(Ljava/lang/String;)Lokhttp3/Protocol;
    ...
    :goto_1
    iput-object v10, v1, Lokhttp3/internal/connection/RealConnection;->protocol:Lokhttp3/Protocol;
    :try_end_1
    ...
    .end local v11    # "maybeProtocol":Ljava/lang/String;
    .local v0, "success":Z
    nop
...
.method public final connect(IIIIZLokhttp3/Call;Lokhttp3/EventListener;)V
    ...
    .line 179
    .local v8, "connectionSpecs":Ljava/util/List;
    new-instance v3, Lokhttp3/internal/connection/ConnectionSpecSelector;

    invoke-direct {v3, v8}, Lokhttp3/internal/connection/ConnectionSpecSelector;-><init>(Ljava/util/List;)V
    ...
    .local v10, "routeException":Lokhttp3/internal/connection/RouteException;
    :goto_2
    nop
    ...
    :try_start_3
    invoke-direct {p0, p1, v12, v2, v1}, Lokhttp3/internal/connection/RealConnection;->connectSocket(IILokhttp3/Call;Lokhttp3/EventListener;)V
    :try_end_3
    ...
    :try_start_4
    invoke-direct {p0, v9, v13, v2, v1}, Lokhttp3/internal/connection/RealConnection;->establishProtocol(Lokhttp3/internal/connection/ConnectionSpecSelector;ILokhttp3/Call;Lokhttp3/EventListener;)V
    ...
    iput-wide v3, p0, Lokhttp3/internal/connection/RealConnection;->idleAtNs:J
    ...
    .line 222
    iput v7, p0, Lokhttp3/internal/connection/RealConnection;->allocationLimit:I
    ...
    .end local v10    # "routeException":Lokhttp3/internal/connection/RouteException;
    .restart local v0    # "routeException":Lokhttp3/internal/connection/RouteException;
    goto :goto_9

    .line 229
    .end local v0    # "routeException":Lokhttp3/internal/connection/RouteException;
    .restart local v10    # "routeException":Lokhttp3/internal/connection/RouteException;
    :cond_a
    ...
    invoke-virtual {v9, v6}, Lokhttp3/internal/connection/ConnectionSpecSelector;->connectionFailed(Ljava/io/IOException;)Z
    ...
    .line 766
    .end local v0    # "routeException":Lokhttp3/internal/connection/RouteException;
    .end local v8    # "connectionSpecs":Ljava/util/List;
    .end local v9    # "connectionSpecSelector":Lokhttp3/internal/connection/ConnectionSpecSelector;
    :cond_d
    move v11, p1
