...
.method private final writeHeader(Lokio/ByteString;JJ)V
    ...
    .local v1, "$this$writeHeader_u24lambda_u240":Lokio/Buffer;
    const/4 v2, 0x0

    .line 102
    .local v2, "$i$a$-apply-Relay$writeHeader$header$1":I
    ...
    .line 101
    .end local v1    # "$this$writeHeader_u24lambda_u240":Lokio/Buffer;
    .end local v2    # "$i$a$-apply-Relay$writeHeader$header$1":I
    move-object v7, v0

    .line 108
    .local v7, "header":Lokio/Buffer;
    ...
    .line 109
    .local v4, "fileOperator":Lokhttp3/internal/cache2/FileOperator;
    ...
    .line 105
    .end local v4    # "fileOperator":Lokhttp3/internal/cache2/FileOperator;
    .end local v7    # "header":Lokio/Buffer;
    .restart local v1    # "$this$writeHeader_u24lambda_u240":Lokio/Buffer;
    .restart local v2    # "$i$a$-apply-Relay$writeHeader$header$1":I
    :cond_1
...
.method public final commit(J)V
    ...
    .line 133
    .local p1, "$i$a$-synchronized-Relay$commit$1":I
    const/4 p2, 0x1
    ...
    .end local p1    # "$i$a$-synchronized-Relay$commit$1":I
