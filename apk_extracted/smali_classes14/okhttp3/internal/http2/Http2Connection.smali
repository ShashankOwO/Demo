...
.method private final newStream(ILjava/util/List;Z)Lokhttp3/internal/http2/Http2Stream;
    ...
    .line 238
    .local v9, "stream":Ljava/lang/Object;
    const/4 v1, 0x0
    ...
    .line 241
    .local v11, "$i$a$-synchronized-Http2Connection$newStream$1":I
    :try_start_0
    monitor-enter p0
    :try_end_0
    ...
    .line 242
    .local v12, "$i$a$-synchronized-Http2Connection$newStream$1$1":I
    :try_start_1
    ...
    .line 241
    .end local v12    # "$i$a$-synchronized-Http2Connection$newStream$1$1":I
    :catchall_0
    move-exception v0
    ...
    .line 245
    .restart local v12    # "$i$a$-synchronized-Http2Connection$newStream$1$1":I
    :cond_0
    :goto_0
    :try_start_3
    ...
    .line 253
    .end local v4    # "inFinished":Z
    .restart local v15    # "inFinished":Z
    :cond_3
    :goto_1
    const/4 v0, 0x1
    ...
    .end local v11    # "$i$a$-synchronized-Http2Connection$newStream$1":I
    sget-object v0, Lkotlin/Unit;->INSTANCE:Lkotlin/Unit;
    :try_end_5
    ...
    .line 1012
    .restart local v11    # "$i$a$-synchronized-Http2Connection$newStream$1":I
    :cond_7
    const/4 v0, 0x0
    ...
    .end local v9    # "stream":Ljava/lang/Object;
    .end local v15    # "inFinished":Z
    ...
    .restart local v9    # "stream":Ljava/lang/Object;
    .restart local v12    # "$i$a$-synchronized-Http2Connection$newStream$1$1":I
...
.method public final pushDataLater$okhttp(ILokio/BufferedSource;IZ)V
    ...
    .line 1127
    invoke-virtual {v0, v1, v9, v10}, Lokhttp3/internal/concurrent/TaskQueue;->schedule(Lokhttp3/internal/concurrent/Task;J)V
...
.method public final pushHeadersLater$okhttp(ILjava/util/List;Z)V
    ...
    .local v6, "streamId":I
    .local v7, "requestHeaders":Ljava/util/List;
    .local v8, "inFinished":Z
    ...
    .line 1114
    invoke-virtual {v0, v2, v9, v10}, Lokhttp3/internal/concurrent/TaskQueue;->schedule(Lokhttp3/internal/concurrent/Task;J)V
...
.method public final pushRequestLater$okhttp(ILjava/util/List;)V
    ...
    .end local v7    # "requestHeaders":Ljava/util/List;
    ...
    .restart local v7    # "requestHeaders":Ljava/util/List;
    :goto_0
    monitor-exit p0
...
.method public final pushResetLater$okhttp(ILokhttp3/internal/http2/ErrorCode;)V
    ...
    .local v6, "streamId":I
    .local v7, "errorCode":Lokhttp3/internal/http2/ErrorCode;
...
.method public final writeWindowUpdateLater$okhttp(IJ)V
    ...
    .end local p1    # "streamId":I
    .end local p2    # "unacknowledgedBytesRead":J
    .local v6, "streamId":I
    .local v7, "unacknowledgedBytesRead":J
