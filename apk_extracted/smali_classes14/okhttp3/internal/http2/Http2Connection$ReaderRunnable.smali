...
.method public headers(ZIILjava/util/List;)V
    ...
    invoke-virtual {v0, v3}, Lokhttp3/internal/http2/Http2Connection;->pushedStream$okhttp(I)Z
    ...
    invoke-virtual {v0, v3, v8, v6}, Lokhttp3/internal/http2/Http2Connection;->pushHeadersLater$okhttp(ILjava/util/List;Z)V
    ...
    :try_start_0
    invoke-virtual {v4, v3}, Lokhttp3/internal/http2/Http2Connection;->getStream(I)Lokhttp3/internal/http2/Http2Stream;
    ...
    .local v10, "stream":Ljava/lang/Object;
    if-nez v10, :cond_4

    .line 672
    :try_start_1
    invoke-static {v4}, Lokhttp3/internal/http2/Http2Connection;->access$isShutdown$p(Lokhttp3/internal/http2/Http2Connection;)Z
    ...
    invoke-virtual {v4}, Lokhttp3/internal/http2/Http2Connection;->getNextStreamId$okhttp()I
    ...
    invoke-virtual {v4, v3}, Lokhttp3/internal/http2/Http2Connection;->setLastGoodStreamId$okhttp(I)V
    ...
    .line 687
    invoke-static {v4}, Lokhttp3/internal/http2/Http2Connection;->access$getTaskRunner$p(Lokhttp3/internal/http2/Http2Connection;)Lokhttp3/internal/concurrent/TaskRunner;
    ...
    .line 1007
    .local v5, "$this$iv":Lokhttp3/internal/concurrent/TaskQueue;
    ...
    .end local v0    # "$i$a$-synchronized-Http2Connection$ReaderRunnable$headers$1":I
    .local v16, "$i$a$-synchronized-Http2Connection$ReaderRunnable$headers$1":I
    new-instance v0, Lokhttp3/internal/http2/Http2Connection$ReaderRunnable$headers$lambda$2$$inlined$execute$default$1;

    invoke-direct {v0, v11, v14, v4, v2}, Lokhttp3/internal/http2/Http2Connection$ReaderRunnable$headers$lambda$2$$inlined$execute$default$1;-><init>(Ljava/lang/String;ZLokhttp3/internal/http2/Http2Connection;Lokhttp3/internal/http2/Http2Stream;)V
    ...
    .line 1013
    invoke-virtual {v5, v0, v12, v13}, Lokhttp3/internal/concurrent/TaskQueue;->schedule(Lokhttp3/internal/concurrent/Task;J)V
    :try_end_4
    ...
    .line 697
    .end local v5    # "$this$iv":Lokhttp3/internal/concurrent/TaskQueue;
    ...
    .end local v16    # "$i$a$-synchronized-Http2Connection$ReaderRunnable$headers$1":I
    monitor-exit v9
    ...
    invoke-virtual {v10, v0, v6}, Lokhttp3/internal/http2/Http2Stream;->receiveHeaders(Lokhttp3/Headers;Z)V
    ...
    .end local v10    # "stream":Ljava/lang/Object;
    .local v2, "stream":Ljava/lang/Object;
    :catchall_1
    move-exception v0
...
.method public invoke()V
    ...
    .end local v1    # "streamErrorCode":Lokhttp3/internal/http2/ErrorCode;
    .local v3, "streamErrorCode":Lokhttp3/internal/http2/ErrorCode;
    goto :goto_0

    .line 627
    .end local v3    # "streamErrorCode":Lokhttp3/internal/http2/ErrorCode;
    .restart local v1    # "streamErrorCode":Lokhttp3/internal/http2/ErrorCode;
    :catchall_0
    move-exception v3
...
.method public ping(ZII)V
    ...
    .line 788
    .local v2, "$i$a$-synchronized-Http2Connection$ReaderRunnable$ping$1":I
    ...
    invoke-static {v0, v5, v6}, Lokhttp3/internal/http2/Http2Connection;->access$setAwaitPongsReceived$p(Lokhttp3/internal/http2/Http2Connection;J)V
    ...
    invoke-static {v0, v3, v4}, Lokhttp3/internal/http2/Http2Connection;->access$setDegradedPongsReceived$p(Lokhttp3/internal/http2/Http2Connection;J)V
    ...
    invoke-static {v0, v3, v4}, Lokhttp3/internal/http2/Http2Connection;->access$setIntervalPongsReceived$p(Lokhttp3/internal/http2/Http2Connection;J)V
    ...
    .line 787
    .end local v2    # "$i$a$-synchronized-Http2Connection$ReaderRunnable$ping$1":I
    :catchall_0
    move-exception v0
    ...
    .line 788
    .restart local v2    # "$i$a$-synchronized-Http2Connection$ReaderRunnable$ping$1":I
    :goto_0
    nop
...
.method public settings(ZLokhttp3/internal/http2/Settings;)V
    ...
    .end local p1    # "clearPrevious":Z
    .end local p2    # "settings":Lokhttp3/internal/http2/Settings;
    .local v6, "clearPrevious":Z
    .local v7, "settings":Lokhttp3/internal/http2/Settings;
