...
.method private final parseExpires(Ljava/lang/String;II)J
    ...
    invoke-virtual {v4, v12, v15}, Ljava/util/GregorianCalendar;->set(II)V
...
.method public final parse$okhttp(JLokhttp3/HttpUrl;Ljava/lang/String;)Lokhttp3/Cookie;
    ...
    invoke-static {v2, v6, v3, v7, v4}, Lokhttp3/internal/Util;->trimSubstring$default(Ljava/lang/String;IIILjava/lang/Object;)Ljava/lang/String;
    ...
    invoke-static {v2, v0, v5}, Lokhttp3/internal/Util;->trimSubstring(Ljava/lang/String;II)Ljava/lang/String;

    move-result-object v11

    .line 380
    .local v11, "cookieValue":Ljava/lang/String;
    ...
    .line 387
    .local v16, "secureOnly":Z
    const/16 v17, 0x0

    .line 388
    .local v17, "httpOnly":Z
    const/16 v18, 0x1

    .line 389
    .local v18, "hostOnly":Z
    const/16 v19, 0x0

    .line 391
    .local v19, "persistent":Z
    ...
    invoke-static {v2, v0, v15, v4}, Lokhttp3/internal/Util;->delimiterOffset(Ljava/lang/String;CII)I

    move-result v6

    .line 396
    .local v6, "attributePairEnd":I
    const/16 v0, 0x3d

    invoke-static {v2, v0, v15, v6}, Lokhttp3/internal/Util;->delimiterOffset(Ljava/lang/String;CII)I

    move-result v7

    .line 397
    .local v7, "attributeEqualsSign":I
    move/from16 v24, v3

    .end local v3    # "pairEqualsSign":I
    .local v24, "pairEqualsSign":I
    invoke-static {v2, v15, v7}, Lokhttp3/internal/Util;->trimSubstring(Ljava/lang/String;II)Ljava/lang/String;
    ...
    invoke-static {v2, v0, v6}, Lokhttp3/internal/Util;->trimSubstring(Ljava/lang/String;II)Ljava/lang/String;
    ...
    .line 404
    .local v25, "attributeValue":Ljava/lang/String;
    nop
    ...
    .local v25, "limit":I
    :try_start_1
    invoke-direct {v1, v2, v4, v0}, Lokhttp3/Cookie$Companion;->parseExpires(Ljava/lang/String;II)J
    ...
    .line 408
    .end local v13    # "expiresAt":J
    .local v26, "expiresAt":J
    const/4 v0, 0x1
    ...
    .end local v26    # "expiresAt":J
    .restart local v13    # "expiresAt":J
    .restart local v18    # "persistent":Z
    :catch_0
    move-exception v0
    ...
    .line 416
    .end local v22    # "deltaSeconds":J
    .local v26, "deltaSeconds":J
    const/4 v0, 0x1
    ...
    .line 417
    .end local v0    # "persistent":Z
    .end local v26    # "deltaSeconds":J
    .restart local v18    # "persistent":Z
    .restart local v22    # "deltaSeconds":J
    :catch_2
    move-exception v0
    ...
    .line 425
    .end local v0    # "domain":Ljava/lang/String;
    .end local v4    # "hostOnly":Z
    .restart local v9    # "domain":Ljava/lang/String;
    .restart local v19    # "hostOnly":Z
    :catch_3
    move-exception v0
    ...
    .end local v16    # "secureOnly":Z
    .local v0, "secureOnly":Z
    goto :goto_4

    .line 435
    .end local v0    # "secureOnly":Z
    .restart local v16    # "secureOnly":Z
    :cond_9
    ...
    .end local v6    # "attributePairEnd":I
    .end local v7    # "attributeEqualsSign":I
    goto/16 :goto_1

    .line 445
    .end local v24    # "pairEqualsSign":I
    ...
    .end local v3    # "pairEqualsSign":I
    .end local v4    # "limit":I
    .restart local v24    # "pairEqualsSign":I
    ...
    .line 463
    :cond_10
    invoke-direct {v1, v0, v9}, Lokhttp3/Cookie$Companion;->domainMatch(Ljava/lang/String;Ljava/lang/String;)Z
    ...
    invoke-virtual {v2}, Lokhttp3/internal/publicsuffix/PublicSuffixDatabase$Companion;->get()Lokhttp3/internal/publicsuffix/PublicSuffixDatabase;

    move-result-object v2

    invoke-virtual {v2, v9}, Lokhttp3/internal/publicsuffix/PublicSuffixDatabase;->getEffectiveTldPlusOne(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {v12, v2, v4, v3, v6}, Lkotlin/text/StringsKt;->startsWith$default(Ljava/lang/String;Ljava/lang/String;ZILjava/lang/Object;)Z
