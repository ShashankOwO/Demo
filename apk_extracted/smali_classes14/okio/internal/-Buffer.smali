...
.method public static final commonIndexOf(Lokio/Buffer;BJJ)J
    ...
    .local v30, "$this$seek$iv":Lokio/Buffer;
    int-to-long v8, v8
    ...
    .end local v30    # "$this$seek$iv":Lokio/Buffer;
    .local v7, "toIndex":J
    ...
    .restart local v30    # "$this$seek$iv":Lokio/Buffer;
    const-wide/16 v5, 0x0
...
.method public static final commonIndexOf(Lokio/Buffer;Lokio/ByteString;J)J
    ...
    .line 1324
    .local v14, "$i$a$-seek--Buffer$commonIndexOf$5":I
    if-nez v6, :cond_4
    ...
    .local v24, "fromIndex":J
    .local v27, "resultLimit":J
    :goto_3
    cmp-long v4, v22, v27
    ...
    .local v4, "a$iv":I
    .local v21, "$this$seek$iv":Lokio/Buffer;
    iget v5, v3, Lokio/Segment;->pos:I

    move-object/from16 v29, v6

    .end local v6    # "s":Lokio/Segment;
    .local v29, "s":Lokio/Segment;
    int-to-long v5, v5
    ...
    invoke-static {v3, v6, v15, v8, v2}, Lokio/internal/-Buffer;->rangeEquals(Lokio/Segment;I[BII)Z
    ...
    .end local v4    # "segmentLimit":I
    .end local v18    # "data":[B
    goto :goto_3

    .line 1349
    .end local v21    # "$this$seek$iv":Lokio/Buffer;
    .end local v29    # "s":Lokio/Segment;
    ...
    .end local v14    # "$i$a$-seek--Buffer$commonIndexOf$5":I
    .end local v15    # "targetByteArray":[B
    .end local v16    # "offset$iv":J
    .end local v22    # "offset":J
    .end local v24    # "fromIndex":J
    .end local v26    # "$i$f$commonIndexOf":I
    .end local v27    # "resultLimit":J
    .local v2, "$i$f$commonIndexOf":I
    :cond_8
    move/from16 v26, v2
    ...
    .end local v5    # "$this$seek$iv":Lokio/Buffer;
    .end local v8    # "fromIndex$iv":J
    .restart local v21    # "$this$seek$iv":Lokio/Buffer;
    .restart local v26    # "$i$f$commonIndexOf":I
    ...
    .end local v6    # "s":Lokio/Segment;
    .end local v7    # "$i$a$-seek--Buffer$commonIndexOf$5":I
    .local v29, "$i$a$-seek--Buffer$commonIndexOf$5":I
    ...
    invoke-static {v8, v4, v9, v5, v15}, Lokio/internal/-Buffer;->rangeEquals(Lokio/Segment;I[BII)Z
    ...
    .end local v29    # "$i$a$-seek--Buffer$commonIndexOf$5":I
...
.method public static final commonIndexOfElement(Lokio/Buffer;Lokio/ByteString;J)J
    ...
    .line 1358
    .local v20, "$i$a$-seek--Buffer$commonIndexOfElement$2":I
    if-nez v12, :cond_3
    ...
    .local v26, "$i$f$commonIndexOfElement":I
    ...
    .line 1368
    .end local v26    # "$i$f$commonIndexOfElement":I
    .local v3, "$i$f$commonIndexOfElement":I
    :cond_7
    move/from16 v26, v3

    .end local v3    # "$i$f$commonIndexOfElement":I
    .restart local v26    # "$i$f$commonIndexOfElement":I
    ...
    .end local v15    # "s":Lokio/Segment;
    .end local v16    # "offset$iv":J
    .end local v20    # "$i$a$-seek--Buffer$commonIndexOfElement$2":I
    .end local v22    # "offset":J
    .end local v24    # "fromIndex":J
    .end local v26    # "$i$f$commonIndexOfElement":I
    .end local v28    # "$this$seek$iv":Lokio/Buffer;
...
.method public static final commonSeek(Lokio/Buffer$UnsafeCursor;J)I
    ...
    invoke-virtual {v0}, Lokio/Buffer$UnsafeCursor;->getSegment$okio()Lokio/Segment;
